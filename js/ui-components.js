...
class AllProjects extends HTMLElement{
    ...
    connectedCallback() {
        ...
        <section id="projects"
        class="container wow animate__fadeInUp padding-90px-top padding-90px-bottom background-black md-padding-50px-top md-padding-50px-bottom sm-padding-30px-top sm-padding-30px-bottom"
        data-wow-delay="1s">
                        ...
                        <li class="branding photography advertising web grid-item wow animate__fadeInUp last-paragraph-no-margin"
                            ...
                            <figure>
                                <div class="portfolio-img bg-deep-pink position-relative text-center overflow-hidden">
                                    ...
                                    <div class="portfolio-icon">
                                        <a href="london.html"><i class="fas fa-search text-extra-dark-gray"
                                                aria-hidden="true"></i></a>
                                    </div>
                                </div>
                                <a href="london.html">
                                    <figcaption class="bg-white">
                                        <div class="portfolio-hover-main text-center">
                                            <div class="portfolio-hover-box align-middle">
                                                <div class="portfolio-hover-content position-relative">
                                                    <span
                                                        class="line-height-normal font-weight-600 text-small alt-font margin-5px-bottom text-extra-dark-gray text-uppercase d-block">London</span>
                                                </div>
                                            </div>
                                        </div>
                                    </figcaption>
                        ...
                        <li class="branding photography advertising web grid-item wow animate__fadeInUp last-paragraph-no-margin"
                            ...
                            <figure>
                                <div class="portfolio-img bg-deep-pink position-relative text-center overflow-hidden">
                                    ...
                                    <div class="portfolio-icon">
                                        <a href="jamaica.html"><i class="fas fa-search text-extra-dark-gray"
                                                aria-hidden="true"></i></a>
                                    </div>
                                </div>
                                <a href="jamaica.html">
                        ...
                        <li class="branding photography advertising web grid-item wow animate__fadeInUp last-paragraph-no-margin"
                            ...
                            <figure>
                                <div class="portfolio-img bg-deep-pink position-relative text-center overflow-hidden">
                                    ...
                                    <div class="portfolio-icon">
                                        <a href="New_York.html"><i class="fas fa-search text-extra-dark-gray"
                                                aria-hidden="true"></i></a>
                                    </div>
                                </div>
                                    ...
                                    <figcaption class="bg-white">
                                        <div class="portfolio-hover-main text-center">
                                            <div class="portfolio-hover-box align-middle">
                                                <div class="portfolio-hover-content position-relative">
                                                    <span
                                                        class="line-height-normal font-weight-600 text-small alt-font margin-5px-bottom text-extra-dark-gray text-uppercase d-block">My friend from Madrid</span>
                                                </div>
                                            </div>
                                        </div>
                                    </figcaption>
